    ...
    <div class="form-warp">
      ...
      >
        ...
        <a-form-item ref="stuid" name="stuid" has-feedback>
          <a-input
            v-model:value="signinState.stuid"
            class="sign-in-input"
            placeholder="输入学号"
          />
        </a-form-item>
        <a-form-item ref="password" name="password" has-feedback>
          <a-input
            v-model:value="signinState.password"
            type="password"
            class="sign-in-input"
            placeholder="输入密码"
          />
      ...
      >
        ...
        <a-form-item ref="stuid" name="stuId" hasFeedback>
          <a-input
            v-model:value="signupState.stuId"
            class="sign-in-input"
            placeholder="输入学号"
          />
        </a-form-item>
        <a-form-item ref="password1" name="password1" hasFeedback>
          <a-input
            v-model:value="signupState.password1"
            type="password"
            class="sign-in-input"
            placeholder="输入密码"
          />
        ...
        <a-form-item ref="password2" name="password2" hasFeedback>
          <a-input
            v-model:value="signupState.password2"
            type="password"
            class="sign-in-input"
            placeholder="确认密码"
          />
